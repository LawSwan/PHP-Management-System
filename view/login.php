<?php
// Login page - Oatmeal-inspired design
// Dark olive theme with elegant typography
        ...
        <div class="bg-[#1d211a]/60 backdrop-blur-sm border border-stone-700/50 rounded-xl shadow-2xl p-8">
            ...
            <div class="text-center">
                <p class="text-stone-400">
                    ...
                    <a href="index.php?action=register" class="text-[#a8b89a] hover:text-[#c8c9c4] font-medium transition-colors duration-200">
                        Create one
                    </a>
                </p>
            </div>
