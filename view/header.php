<?php
// Header layout - Oatmeal-inspired design
// Dark olive theme with elegant serif typography
?>
...
<body class="text-stone-300 antialiased">
    <!-- Navigation Header - Oatmeal Style -->
    <nav class="border-b border-stone-800/50 sticky top-0 z-50 backdrop-blur-sm bg-[#0d0f0a]/80">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <!-- Left Navigation Links -->
                <div class="hidden md:flex items-center space-x-6">
                    <a href="index.php?action=enter_complaint" class="text-stone-400 hover:text-stone-200 text-sm font-medium transition-colors duration-200">
                        Submit
                    </a>
                    <a href="index.php?action=complaint_list" class="text-stone-400 hover:text-stone-200 text-sm font-medium transition-colors duration-200">
                        My Tickets
                    </a>
                    <a href="index.php?action=sitemap" class="text-stone-400 hover:text-stone-200 text-sm font-medium transition-colors duration-200">
                        Site Map
                    </a>
                </div>
                ...
                <div class="absolute left-1/2 transform -translate-x-1/2">
                    <a href="index.php" class="font-serif text-2xl font-medium text-[#f5f3eb] tracking-tight hover:opacity-80 transition-opacity">
                        VelocityNet
                    </a>
                </div>
        ...
        <div id="mobile-menu" class="hidden md:hidden border-t border-stone-800/50 bg-[#0d0f0a]">
            <div class="px-4 py-4 space-y-3">
                <a href="index.php?action=enter_complaint" class="block text-stone-400 hover:text-stone-200 text-sm font-medium py-2 transition-colors">
                    Submit Complaint
                </a>
                <a href="index.php?action=complaint_list" class="block text-stone-400 hover:text-stone-200 text-sm font-medium py-2 transition-colors">
                    My Tickets
                </a>
                <a href="index.php?action=sitemap" class="block text-stone-400 hover:text-stone-200 text-sm font-medium py-2 transition-colors">
                    Site Map
                </a>
