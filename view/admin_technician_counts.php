            ...
            <tbody class="divide-y divide-gray-700">
                <?php foreach ($countList as $countRow) { ?>
                    <tr class="hover:bg-gray-700/30 transition-colors duration-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="text-sm text-gray-400"><?php echo $countRow["user_id"]; ?></span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-white">
                                        <?php echo $countRow["last_name"]; ?>, <?php echo $countRow["first_name"]; ?>
                                    </div>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="index.php?action=technician_complaint_list&employee_id=<?php echo $countRow["employee_id"]; ?>" 
