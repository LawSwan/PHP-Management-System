...
if ($action == "") {
    ...
    <div class="hero text-center py-16 md:py-24">
        ...
        <div class="inline-flex items-center gap-2 px-4 py-2 bg-[#1d211a] border border-stone-700/50 rounded-full text-sm text-stone-400 mb-8">
            ...
            <a href="index.php?action=sitemap" class="text-[#a8b89a] hover:text-[#f5f3eb] transition-colors flex items-center gap-1">
                Learn more
        ...
        <p class="text-lg text-stone-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            Submit your concerns, track their progress, and get personalized responses from our support team &mdash; all in one place.
        </p>
    ...
    <!-- Quick Links Section (for development navigation) -->
    <div class="max-w-5xl mx-auto px-4 pb-16">
        <div class="bg-[#1d211a]/50 border border-stone-700/50 rounded-xl p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="index.php?action=login" class="text-sm text-stone-500 hover:text-[#a8b89a] transition-colors">Login</a></li>
                        <li><a href="index.php?action=register" class="text-sm text-stone-500 hover:text-[#a8b89a] transition-colors">Register</a></li>
                        <li><a href="index.php?action=enter_complaint" class="text-sm text-stone-500 hover:text-[#a8b89a] transition-colors">Enter Complaint</a></li>
                        <li><a href="index.php?action=complaint_list" class="text-sm text-stone-500 hover:text-[#a8b89a] transition-colors">Complaint List</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="index.php?action=admin_customer_list" class="text-sm text-stone-500 hover:text-[#a8b89a] transition-colors">Customers</a></li>
                        <li><a href="index.php?action=admin_employee_list" class="text-sm text-stone-500 hover:text-[#a8b89a] transition-colors">Employees</a></li>
                        <li><a href="index.php?action=admin_complaint_open_list" class="text-sm text-stone-500 hover:text-[#a8b89a] transition-colors">Open Complaints</a></li>
                        <li><a href="index.php?action=admin_complaint_unassigned_list" class="text-sm text-stone-500 hover:text-[#a8b89a] transition-colors">Unassigned Complaints</a></li>
                        <li><a href="index.php?action=admin_technician_counts" class="text-sm text-stone-500 hover:text-[#a8b89a] transition-colors">Technician Counts</a></li>
                        <li><a href="index.php?action=admin_complaint_assign" class="text-sm text-stone-500 hover:text-[#a8b89a] transition-colors">Assign Complaint</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="index.php?action=technician_complaint_list&employee_id=1" class="text-sm text-stone-500 hover:text-[#a8b89a] transition-colors">My Complaints (id 1)</a></li>
                        <li><a href="index.php?action=sitemap" class="text-sm text-stone-500 hover:text-[#a8b89a] transition-colors">Site Map</a></li>
                    </ul>
                </div>
            </div>
        </div>
